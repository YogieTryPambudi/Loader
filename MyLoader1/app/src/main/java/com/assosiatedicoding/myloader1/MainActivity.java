package com.assosiatedicoding.myloader1;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(CONTACT_LOAD_ID, null, (android.support.v4.app.LoaderManager.LoaderCallbacks<Object>) this);
    }
    @Override
    ...
    private void getPhoneNumber(String contactID){
        ...
        getSupportLoaderManager().restartLoader(CONTACT_PHONE_ID, bundle, (android.support.v4.app.LoaderManager.LoaderCallbacks<Object>) this);
    }
}